...
const models: TsoaRoute.Models = {
    ...
    "BasicData": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"basicDataGold":{"dataType":"double","required":true},"basicDataMaxHunger":{"dataType":"double","required":true},"basicDataCurrentHunger":{"dataType":"double","required":true},"basicDataSkillRegen":{"dataType":"double","required":true},"basicDataEnhancements":{"dataType":"double","required":true},"basicDataJP":{"dataType":"double","required":true},"basicDataNext":{"dataType":"double","required":true},"basicDataExp":{"dataType":"double","required":true},"basicDataLevel":{"dataType":"double","required":true},"basicDataMaxSP":{"dataType":"double","required":true},"basicDataCurrentSP":{"dataType":"double","required":true},"basicDataMaxMP":{"dataType":"double","required":true},"basicDataCurrentMP":{"dataType":"double","required":true},"basicDataMaxHP":{"dataType":"double","required":true},"basicDataCurrentHP":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Attributes": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"attributeVitality":{"dataType":"double","required":true},"attributeStrength":{"dataType":"double","required":true},"attributeSpirit":{"dataType":"double","required":true},"attributeLuck":{"dataType":"double","required":true},"attributeDexterity":{"dataType":"double","required":true},"attributeAgility":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "BasicStats": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"basicStatMagicalDice":{"dataType":"double","required":true},"basicStatMagicalDefense":{"dataType":"double","required":true},"basicStatPhysicalDice":{"dataType":"double","required":true},"basicStatPhysicalDefense":{"dataType":"double","required":true},"basicStatCritical":{"dataType":"double","required":true},"basicStatMove":{"dataType":"double","required":true},"basicStatDodge":{"dataType":"double","required":true},"basicStatInitiative":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Ranges": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"rangeFireWeapon":{"dataType":"double","required":true},"rangeRangedWeapon":{"dataType":"double","required":true},"rangeMeleeWeapon":{"dataType":"double","required":true},"rangeUnarmed":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Accuracies": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"accuracyFireWeapon":{"dataType":"double","required":true},"accuracyRangedWeapon":{"dataType":"double","required":true},"accuracyMeleeWeapon":{"dataType":"double","required":true},"accuracyUnarmed":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "PhysicalBonus": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"bonusFireWeapon":{"dataType":"double","required":true},"bonusRangedWeapon":{"dataType":"double","required":true},"bonusMeleeWeapon":{"dataType":"double","required":true},"bonusUnarmed":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "MagicalBonus": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"bonusElementWind":{"dataType":"double","required":true},"bonusElementWater":{"dataType":"double","required":true},"bonusElementThunder":{"dataType":"double","required":true},"bonusElementSun":{"dataType":"double","required":true},"bonusElementNature":{"dataType":"double","required":true},"bonusElementMoon":{"dataType":"double","required":true},"bonusElementMagick":{"dataType":"double","required":true},"bonusElementLight":{"dataType":"double","required":true},"bonusElementIce":{"dataType":"double","required":true},"bonusElementFire":{"dataType":"double","required":true},"bonusElementEthereal":{"dataType":"double","required":true},"bonusElementEarth":{"dataType":"double","required":true},"bonusElementDark":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Expertises": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"expertiseSynergy":{"dataType":"double","required":true},"expertiseStunt":{"dataType":"double","required":true},"expertiseSteal":{"dataType":"double","required":true},"expertiseSpecialWeapon":{"dataType":"double","required":true},"expertiseRelaxation":{"dataType":"double","required":true},"expertisePVP":{"dataType":"double","required":true},"expertiseMVP":{"dataType":"double","required":true},"expertiseFaith":{"dataType":"double","required":true},"expertiseCombo":{"dataType":"double","required":true},"expertiseChemistry":{"dataType":"double","required":true},"expertiseAstronomy":{"dataType":"double","required":true},"expertiseTactic":{"dataType":"double","required":true},"expertiseForecastWeather":{"dataType":"double","required":true},"expertisePerception":{"dataType":"double","required":true},"expertiseNegotiate":{"dataType":"double","required":true},"expertiseMysticism":{"dataType":"double","required":true},"expertiseCurse":{"dataType":"double","required":true},"expertiseLanguage":{"dataType":"double","required":true},"expertiseIntimidate":{"dataType":"double","required":true},"expertiseInterrogate":{"dataType":"double","required":true},"expertiseInterpretDreams":{"dataType":"double","required":true},"expertiseElementWind":{"dataType":"double","required":true},"expertiseElementWater":{"dataType":"double","required":true},"expertiseElementThunder":{"dataType":"double","required":true},"expertiseElementSun":{"dataType":"double","required":true},"expertiseElementNature":{"dataType":"double","required":true},"expertiseElementMoon":{"dataType":"double","required":true},"expertiseElementMagick":{"dataType":"double","required":true},"expertiseElementLight":{"dataType":"double","required":true},"expertiseElementIce":{"dataType":"double","required":true},"expertiseElementFire":{"dataType":"double","required":true},"expertiseElementEthereal":{"dataType":"double","required":true},"expertiseElementEarth":{"dataType":"double","required":true},"expertiseElementDark":{"dataType":"double","required":true},"expertiseMagicalDefense":{"dataType":"double","required":true},"expertiseConjuration":{"dataType":"double","required":true},"expertiseBluff":{"dataType":"double","required":true},"expertiseSupport":{"dataType":"double","required":true},"expertiseMagickFind":{"dataType":"double","required":true},"expertisePlayCalculate":{"dataType":"double","required":true},"expertiseCritical":{"dataType":"double","required":true},"expertiseSurvival":{"dataType":"double","required":true},"expertiseLeadership":{"dataType":"double","required":true},"expertisePhysicalDefense":{"dataType":"double","required":true},"expertiseCharisma":{"dataType":"double","required":true},"expertiseFirstAid":{"dataType":"double","required":true},"expertisePrepareTrap":{"dataType":"double","required":true},"expertisePilot":{"dataType":"double","required":true},"expertiseSwim":{"dataType":"double","required":true},"expertiseMakeBoat":{"dataType":"double","required":true},"expertiseClimb":{"dataType":"double","required":true},"expertiseThrowObject":{"dataType":"double","required":true},"expertiseMasonry":{"dataType":"double","required":true},"expertiseFireWeapons":{"dataType":"double","required":true},"expertiseRangedWeapons":{"dataType":"double","required":true},"expertiseAgriculture":{"dataType":"double","required":true},"expertiseJump":{"dataType":"double","required":true},"expertiseFlee":{"dataType":"double","required":true},"expertiseDodge":{"dataType":"double","required":true},"expertiseHide":{"dataType":"double","required":true},"expertiseDualWield":{"dataType":"double","required":true},"expertiseDisguise":{"dataType":"double","required":true},"expertiseMislead":{"dataType":"double","required":true},"expertiseTrack":{"dataType":"double","required":true},"expertiseMount":{"dataType":"double","required":true},"expertiseMine":{"dataType":"double","required":true},"expertiseUnarmedFight":{"dataType":"double","required":true},"expertiseImmobilize":{"dataType":"double","required":true},"expertiseForge":{"dataType":"double","required":true},"expertiseWillpower":{"dataType":"double","required":true},"expertiseMechanicalWeapons":{"dataType":"double","required":true},"expertiseMeleeWeapons":{"dataType":"double","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "FixedOperators": {
        "dataType": "refEnum",
    ...
    "EffectFieldsList": {
        "dataType": "refEnum",
        "enums": ["basicDataCurrentHP","basicDataMaxHP","basicDataCurrentMP","basicDataMaxMP","basicDataCurrentSP","basicDataMaxSP","basicDataLevel","basicDataGold","attributeAgility","attributeDexterity","attributeLuck","attributeSpirit","attributeStrength","attributeVitality","basicStatInitiative","basicStatDodge","basicStatMove","basicStatCritical","basicStatPhysicalDefense","basicStatPhysicalDice","basicStatMagicalDefense","basicStatMagicalDice","rangeUnarmed","rangeMeleeWeapon","rangeRangedWeapon","rangeFireWeapon","accuracyUnarmed","accuracyMeleeWeapon","accuracyRangedWeapon","accuracyFireWeapon","bonusUnarmed","bonusMeleeWeapon","bonusRangedWeapon","bonusFireWeapon","bonusElementDark","bonusElementEarth","bonusElementEthereal","bonusElementFire","bonusElementIce","bonusElementLight","bonusElementMagick","bonusElementMoon","bonusElementNature","bonusElementSun","bonusElementThunder","bonusElementWater","bonusElementWind","expertiseMeleeWeapons","expertiseMechanicalWeapons","expertiseWillpower","expertiseForge","expertiseImmobilize","expertiseUnarmedFight","expertiseMine","expertiseMount","expertiseTrack","expertiseMislead","expertiseDisguise","expertiseDualWield","expertiseHide","expertiseDodge","expertiseFlee","expertiseJump","expertiseAgriculture","expertiseRangedWeapons","expertiseFireWeapons","expertiseMasonry","expertiseThrowObject","expertiseClimb","expertiseMakeBoat","expertiseSwim","expertisePilot","expertisePrepareTrap","expertiseFirstAid","expertiseCharisma","expertisePhysicalDefense","expertiseLeadership","expertiseSurvival","expertiseCritical","expertisePlayCalculate","expertiseMagickFind","expertiseSupport","expertiseBluff","expertiseConjuration","expertiseMagicalDefense","expertiseElementDark","expertiseElementEarth","expertiseElementEthereal","expertiseElementFire","expertiseElementIce","expertiseElementLight","expertiseElementMagick","expertiseElementMoon","expertiseElementNature","expertiseElementSun","expertiseElementThunder","expertiseElementWater","expertiseElementWind","expertiseInterpretDreams","expertiseInterrogate","expertiseIntimidate","expertiseLanguage","expertiseCurse","expertiseMysticism","expertiseNegotiate","expertisePerception","expertiseForecastWeather","expertiseTactic","expertiseAstronomy","expertiseChemistry","expertiseCombo","expertiseFaith","expertiseMVP","expertisePVP","expertiseRelaxation","expertiseSpecialWeapon","expertiseSteal","expertiseStunt","expertiseSynergy"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "LinkedOperators": {
        "dataType": "refEnum",
